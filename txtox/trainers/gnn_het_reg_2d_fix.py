...
from txtox.models.gnn_het_reg_2d_fix import LitGNNHetReg2dfix
...
def main():
    ...
    # paths
    paths = get_paths()
    expname = get_datetime(expname="one_sec_hemi_nhood_GNNhetReg_attres_2d_fix_ce-0.1")
    ...
    # model
    model = LitGNNHetReg2dfix(input_dim=n_genes, n_labels=n_labels, weight_gnll=1.0, weight_ce=0.1)
