...
class LitGNNHetReg2dfix(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Calculate losses
        l2norm_loss = 0.5 * self.loss_l2norm(xy_mu_pred, xy)
        gnll_loss = self.loss_gnll2d(xy_mu_pred.detach(), xy_L_pred, xy)
