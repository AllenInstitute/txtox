...
class LitGNNHetRegGauss2d(L.LightningModule):
    def __init__(self, input_dim=784, hidden_dim=10, n_labels=10, weight_gnll=1.0, weight_ce=1.0):
        ...
        self.encoder = torch.nn.Sequential(torch.nn.Dropout(0.5), torch.nn.Linear(hidden_dim*n_heads, 20), torch.nn.LayerNorm(20))
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_gnll_loss", gnll_loss, batch_size=batch_size, **log_config)
