...
class LitGNNHetReg(L.LightningModule):
    def __init__(self, input_dim=500, hidden_dim=10, n_labels=126, weight_gnll=1.0, weight_ce=1.0):
        ...
        self.spatial_mu_out = torch.nn.Sequential(torch.nn.Linear(20, 20), torch.nn.GELU(), torch.nn.Linear(20, 2))
        self.spatial_l_out = torch.nn.Sequential(torch.nn.Linear(20, 20), torch.nn.GELU(), torch.nn.Linear(20, 3))
    ...
    def forward(self, x, edge_index):
        ...
        xyz_L = vec2mat_cholesky2d(self.spatial_l_out(x))
